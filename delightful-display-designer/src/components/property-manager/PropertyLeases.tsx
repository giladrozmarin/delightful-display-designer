...
export function PropertyLeases({ leases, propertyId }: PropertyLeasesProps) {
        ...
        <Table>
          ...
          <TableBody>
            {leases.map((lease) => (
              ...
              >
                <TableCell>
                  <div className="font-medium">Unit {lease.unitNumber}</div>
                </TableCell>
        ...
        <div className="text-center py-10 text-gray-500">
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-gray-500 max-w-md">
              This property doesn't have any leases yet. Create a new lease to get started.
            </p>
          </div>
        </div>
      )}
